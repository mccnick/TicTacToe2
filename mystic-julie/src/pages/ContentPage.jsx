...
const trailerVideo = {
  ...
  embedUrl:
    'https://player.twitch.tv/?video=2629823914&parent=localhost&autoplay=false',
  description:
...
const highlightClip = {
    title: 'IRL Picnic :DD',
    embedUrl:
      'https://clips.twitch.tv/embed?clip=HedonisticEnticingOwlDxAbomb-s--cBj6OeBkB6bxL&parent=localhost',
...
const clipVideos = [
  ...
  embedUrl:
    'https://clips.twitch.tv/embed?clip=MiniatureCreativeGoblinStoneLightning-wMSkUbFUcS7YSooQ&parent=localhost',
  ...
  },
  {
    ...
    embedUrl:
      'https://clips.twitch.tv/embed?clip=GenerousVibrantKangarooEleGiggle-q2FOJxrRJjyQdaVC&parent=localhost',
    description: 'LOL',
  },
  {
    title: 'A nasty clutch on Valorant :DD',
    embedUrl:
      'https://clips.twitch.tv/embed?clip=LovelyVenomousLeopardShadyLulu-W_CQY0i6jAcXUFvF&parent=localhost',
      description: 'WOOOO',
  }
]
